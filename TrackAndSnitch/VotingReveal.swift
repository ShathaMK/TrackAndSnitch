...
struct VotingReveal: View {
    ...
    var mostVotedPlayerRole: String // New parameter to accept the role
...
struct VotingReveal_Previews: PreviewProvider {
    static var previews: some View {
        ...
        // Sample most voted player's role (you can change this to test)
        let mostVotedPlayerRole = "Thief" // or "Tracker", etc.
        
        return VotingReveal(playersData: samplePlayersData, playersVotes: samplePlayersVotes, mostVotedPlayerRole: mostVotedPlayerRole)
    }
}
